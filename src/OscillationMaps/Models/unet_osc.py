...
class UNet(nn.Module):
    ...
    def forward(self, x, osc_params):
        """
        Apply the model to an input batch.
        :param x: an [N x 2 x ...] Tensor of inputs (B&W)
        :param osc_params: Tensor of shape [N x 4] containing theta_12, theta_13, theta_23, m_31
        :return: an [N x C x ...] Tensor of outputs.
        """
        hs = []

        # Embed the oscillation parameters
        emb = self.cond_embed(osc_params)
